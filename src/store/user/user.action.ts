import { USER_ACTION_TYPES, UserData, AdditionalInformation } from './user.types';
...
export const googleSignInStart = withMatcher((): GoogleSignInStart => createAction(USER_ACTION_TYPES.GOOGLE_SING_IN_START))
